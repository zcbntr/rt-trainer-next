        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-12">
          <div className="space-y-4 p-4 md:col-span-6">
            ...
            <p className="max-w-xl opacity-60">
              Gain confidence in your radio telephony skills by practicing with
              our RT trainer directly in your browser.
            </p>
            <ul className="list-items">
              <li>
                ...
                <span>
                  <b>Supports voice input</b> – speak your radio calls out loud,
          ...
          {/* <Image
            ...
            src={planeGraphic}
            className="my-2 max-h-[500px] max-w-[500px] p-2 sm:col-span-6"
            width={500}
            height={500}
            alt="Plane drawing"
            unoptimized
