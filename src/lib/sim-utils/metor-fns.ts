...
export default function getMETORSample(seed: number, metorData: METORData): METORDataSample {
    ...
    const windDirection =
        seededNormalDistribution(seed.toString(), metorData.avgWindDirection, 10.0) % 360.0;
